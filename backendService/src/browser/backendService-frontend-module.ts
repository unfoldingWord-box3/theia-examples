...
import { BackendServiceCommandContribution} from './backendService-contribution';

export default new ContainerModule(bind => {
    bind(CommandContribution).to(BackendServiceCommandContribution).inSingletonScope();
